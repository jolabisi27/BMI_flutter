...
class CalculatorBrain {
  ...
  String calculateBMI(){  _bmi =weight/pow(height/100, 2);
  return _bmi.toStringAsFixed(1);
  }
 String getResult (){
    if (_bmi>=25){return'Overweght';}
 ...
 String getInterpretation (){
   ...
   else {return'You have lower than a normal body weight.You can eat more or your consult your doctor';}
